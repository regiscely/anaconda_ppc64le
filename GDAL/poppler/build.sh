...
export LDFLAGS="${LDFLAGS} -L${PREFIX}/lib -L/lib64"

if [ -n "$OSX_ARCH" ] ; then
    export LDFLAGS="${LDFLAGS} -Wl,-rpath,${PREFIX}/lib -Wl,-rpath,/lib64"
    ...
    export LDFLAGS="${LDFLAGS} -Wl,-rpath-link,${PREFIX}/lib -Wl,-rpath-link,/lib64"
fi
